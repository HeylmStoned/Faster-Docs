...
Emitted when a token graduates to Uniswap V3 on Prism.
...
Emitted when a Uniswap V3 on Prism pool is created.
...
Emitted when LP fees are collected from Uniswap V3 on Prism.
