...
- **Auto-Graduation** - Tokens graduate to Uniswap V3 on Prism when 30 ETH raised
...
- **DEXs / DeFi** – After graduation, use the wrapper address as the token in Uniswap V3 on Prism or any ERC-20–compatible protocol.
