...
Graduates tokens from bonding curve to Uniswap V3 on Prism.
...
- Creating Uniswap V3 on Prism pools
...
## Uniswap V3 on Prism Configuration
...
5. **Pool Created** - Uniswap V3 on Prism pool initialized with ~316k tokens + ~29.9 ETH
...
Graduate token to Uniswap V3 on Prism. Usually auto-called when target met.
...
**Returns:**
- `pool` - Uniswap V3 on Prism pool address
